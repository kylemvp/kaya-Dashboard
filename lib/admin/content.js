...
export function emptyLocation() {
  return {
    id: '', country: 'UAE', name: '', city: '', addr: '', tel: '', hours: '', mapQ: '',
    // Opening date, as yyyy-mm-dd. Blank on the existing clinics: the real
    // dates aren't in the data anywhere, and inventing them would put made-up
    // facts in front of the team. They fill them in as they go.
    opened: '',
  }
}
